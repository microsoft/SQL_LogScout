if exists (select * from sys.server_event_sessions where name= 'pssdiag_xevent_detailed') drop  EVENT SESSION [pssdiag_xevent_detailed] ON SERVER 
GO
CREATE EVENT SESSION [pssdiag_xevent_detailed] ON SERVER 
...
GO
alter  EVENT SESSION [pssdiag_xevent_detailed] ON SERVER  ADD EVENT sqlserver.cursor_implicit_conversion (     
ACTION (package0.event_sequence, sqlserver.client_app_name, sqlserver.client_hostname, sqlserver.client_pid, sqlserver.database_id, sqlserver.database_name, sqlserver.is_system, sqlserver.nt_username, sqlserver.query_hash, sqlserver.request_id, sqlserver.server_principal_name, sqlserver.session_server_principal_name, sqlserver.session_id, sqlserver.session_nt_username, sqlserver.sql_text, sqlserver.transaction_id, sqlserver.username)     
  WHERE (([sqlserver].[client_hostname]<>N'pssdiag') AND ([sqlserver].[client_hostname]<>N'pssdiag_stop') AND ([sqlserver].[client_hostname]<>N'pssdiag_cleanup'))
)
GO
alter  EVENT SESSION [pssdiag_xevent_detailed] ON SERVER  ADD EVENT sqlserver.databases_log_growth (     
ACTION (package0.event_sequence, sqlserver.client_app_name, sqlserver.client_hostname, sqlserver.client_pid, sqlserver.database_id, sqlserver.database_name, sqlserver.is_system, sqlserver.nt_username, sqlserver.query_hash, sqlserver.request_id, sqlserver.server_principal_name, sqlserver.session_server_principal_name, sqlserver.session_id, sqlserver.session_nt_username, sqlserver.sql_text, sqlserver.transaction_id, sqlserver.username)     
  WHERE (([sqlserver].[client_hostname]<>N'pssdiag') AND ([sqlserver].[client_hostname]<>N'pssdiag_stop') AND ([sqlserver].[client_hostname]<>N'pssdiag_cleanup'))
)
GO
alter  EVENT SESSION [pssdiag_xevent_detailed] ON SERVER  ADD EVENT sqlserver.databases_log_shrink (     
ACTION (package0.event_sequence, sqlserver.client_app_name, sqlserver.client_hostname, sqlserver.client_pid, sqlserver.database_id, sqlserver.database_name, sqlserver.is_system, sqlserver.nt_username, sqlserver.query_hash, sqlserver.request_id, sqlserver.server_principal_name, sqlserver.session_server_principal_name, sqlserver.session_id, sqlserver.session_nt_username, sqlserver.sql_text, sqlserver.transaction_id, sqlserver.username)     
  WHERE (([sqlserver].[client_hostname]<>N'pssdiag') AND ([sqlserver].[client_hostname]<>N'pssdiag_stop') AND ([sqlserver].[client_hostname]<>N'pssdiag_cleanup'))
)
GO
alter  EVENT SESSION [pssdiag_xevent_detailed] ON SERVER  ADD EVENT sqlserver.additional_memory_grant (     ACTION (package0.event_sequence, sqlserver.client_app_name, sqlserver.client_hostname, sqlserver.client_pid, sqlserver.database_id, sqlserver.database_name, sqlserver.is_system, sqlserver.nt_username, sqlserver.query_hash, sqlserver.request_id, sqlserver.server_principal_name, sqlserver.session_server_principal_name, sqlserver.session_id, sqlserver.session_nt_username, sqlserver.sql_text, sqlserver.transaction_id, sqlserver.username)
  WHERE (([sqlserver].[client_hostname]<>N'pssdiag') AND ([sqlserver].[client_hostname]<>N'pssdiag_stop') AND ([sqlserver].[client_hostname]<>N'pssdiag_cleanup'))
)
GO
