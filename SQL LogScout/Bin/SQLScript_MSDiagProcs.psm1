    ...
    function MSDiagProcs_Query([Boolean] $returnVariable = $false)
    {
        Write-LogDebug "Inside" $MyInvocation.MyCommand

        [String] $collectorName = "MSDiagProcs"
        ...
        */
        ...
        END*/
        PRINT ''
        RAISERROR ('===== Creating #sp_sqldiag08', 0, 1) WITH NOWAIT
        GO
        CREATE PROC dbo.#sp_sqldiag08 @bGetSyscacheobjects int = 0 
        AS
        BEGIN
        EXEC dbo.#sp_sqldiag07 @bGetSyscacheobjects
        END
        GO
        ...
        */
        ...
        GO
        PRINT ''
        RAISERROR ('===== Creating #sp_code_runner08', 0, 1) WITH NOWAIT
        GO
        CREATE PROC dbo.#sp_code_runner08 @StartCmd nvarchar(4000)='/?', @StartTime char(8)=NULL, @StopCondition nvarchar(4000)=NULL,
        @StopMessage nvarchar(4000)='Stop condition met.', @IterationTime char(8)=NULL, @Duration char(8)=NULL, @StopCmd nvarchar(4000)=NULL, 
        @PollingInterval char(8)='00:00:05', @PauseBetweenRuns char(8)=NULL,
        @OutputDir sysname=NULL, @OutputFileMask sysname=NULL, @NumFiles int=16
        AS
        BEGIN
        EXEC dbo.#sp_code_runner07 @StartCmd, @StartTime, @StopCondition,
            @StopMessage, @IterationTime, @Duration, @StopCmd, 
            @PollingInterval, @PauseBetweenRuns,
            @OutputDir, @OutputFileMask, @NumFiles
        END
        GO
        PRINT ''
        RAISERROR ('===== Creating #sp_code_runner09', 0, 1) WITH NOWAIT
        GO
        CREATE PROC dbo.#sp_code_runner09 @StartCmd nvarchar(4000)='/?', @StartTime char(8)=NULL, @StopCondition nvarchar(4000)=NULL,
        @StopMessage nvarchar(4000)='Stop condition met.', @IterationTime char(8)=NULL, @Duration char(8)=NULL, @StopCmd nvarchar(4000)=NULL, 
        @PollingInterval char(8)='00:00:05', @PauseBetweenRuns char(8)=NULL,
        @OutputDir sysname=NULL, @OutputFileMask sysname=NULL, @NumFiles int=16
        AS
        ...
        GO
        PRINT ''
        RAISERROR ('===== Creating #sp_code_runner10', 0, 1) WITH NOWAIT
        GO
        CREATE PROC dbo.#sp_code_runner10 @StartCmd nvarchar(4000)='/?', @StartTime char(8)=NULL, @StopCondition nvarchar(4000)=NULL,
        @StopMessage nvarchar(4000)='Stop condition met.', @IterationTime char(8)=NULL, @Duration char(8)=NULL, @StopCmd nvarchar(4000)=NULL, 
        @PollingInterval char(8)='00:00:05', @PauseBetweenRuns char(8)=NULL,
        @OutputDir sysname=NULL, @OutputFileMask sysname=NULL, @NumFiles int=16
        AS
        ...
        GO
        PRINT ''
        RAISERROR ('===== Creating #sp_code_runner11', 0, 1) WITH NOWAIT
        GO
        CREATE PROC dbo.#sp_code_runner11 @StartCmd nvarchar(4000)='/?', @StartTime char(8)=NULL, @StopCondition nvarchar(4000)=NULL,
        @StopMessage nvarchar(4000)='Stop condition met.', @IterationTime char(8)=NULL, @Duration char(8)=NULL, @StopCmd nvarchar(4000)=NULL, 
        @PollingInterval char(8)='00:00:05', @PauseBetweenRuns char(8)=NULL,
        @OutputDir sysname=NULL, @OutputFileMask sysname=NULL, @NumFiles int=16
        AS
        ...
        GO
        PRINT ''
        RAISERROR ('===== Creating #sp_code_runner12', 0, 1) WITH NOWAIT
        GO
        CREATE PROC dbo.#sp_code_runner12 @StartCmd nvarchar(4000)='/?', @StartTime char(8)=NULL, @StopCondition nvarchar(4000)=NULL,
        @StopMessage nvarchar(4000)='Stop condition met.', @IterationTime char(8)=NULL, @Duration char(8)=NULL, @StopCmd nvarchar(4000)=NULL, 
        @PollingInterval char(8)='00:00:05', @PauseBetweenRuns char(8)=NULL,
        @OutputDir sysname=NULL, @OutputFileMask sysname=NULL, @NumFiles int=16
        AS
        ...
        GO
        PRINT ''
        RAISERROR ('===== Creating #sp_code_runner13', 0, 1) WITH NOWAIT
        GO
        CREATE PROC dbo.#sp_code_runner13 @StartCmd nvarchar(4000)='/?', @StartTime char(8)=NULL, @StopCondition nvarchar(4000)=NULL,
        @StopMessage nvarchar(4000)='Stop condition met.', @IterationTime char(8)=NULL, @Duration char(8)=NULL, @StopCmd nvarchar(4000)=NULL, 
        @PollingInterval char(8)='00:00:05', @PauseBetweenRuns char(8)=NULL,
        @OutputDir sysname=NULL, @OutputFileMask sysname=NULL, @NumFiles int=16
        AS
