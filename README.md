...
1. **DebugLevel** - this parameter is no longer honored in version 4. It is still present but will not do anything. See [Debug Log](#sqllogscout_debuglog-file) for detailed-level debugging information. This parameter will be removed in future versions.
